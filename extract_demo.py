...
def run_extraction():
    ...
    print("Extracting first 3 pages using Gemini 3.6 Flash Vision...")
    text = extract_text_from_pdf(pdf_path, max_pages=3)
    
    with open('/home/ashish/projects/awgp_audiobook_pipeline/brahma_sandhya_gemini.txt', 'w', encoding='utf-8') as f:
        f.write(text)
